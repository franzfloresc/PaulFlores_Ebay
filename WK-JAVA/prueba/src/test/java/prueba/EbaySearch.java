...
public class EbaySearch {
	...
	By resultadoLocator = By.linkText("Guardar esta búsqueda");
	...
	By preciobajoPrimero = By.xpath("//span[contains(text(),'Precio + Envío: más bajo primero')]");
	By precioaltoPrimero = By.xpath("//span[contains(text(),'Precio + Envío: más alto primero')]");
	...
	public void testEbayPage() {
		...
		//Imprimiendo el número de resultados
